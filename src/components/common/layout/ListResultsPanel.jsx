...
/**
 * Panel reutilizable para listados con cabecera, alerta, loading, error, estado vacío, contenido (lista) y paginación.
 * El contenido de la lista se pasa como children (p. ej. map de ReservationListItem o VehicleListItem).
 */
