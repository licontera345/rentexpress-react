/**
 * Utilidades para formularios de alquiler (editar).
 * Basado en RentalDTO del OpenAPI: rentalId, startDateEffective, endDateEffective,
 * initialKm, finalKm, rentalStatusId, totalCost, pickupHeadquartersId, returnHeadquartersId.
 */
