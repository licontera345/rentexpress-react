/**
 * Utilidades de reservas: estados, formulario, resumen y resolución de datos.
 * Consolidado desde reservationStatusUtils, reservationFormUtils, reservationSummaryUtils y reservas.
 */
import { t } from '../i18n';
import { MESSAGES, getHeadquartersAddressLabel, getHeadquartersNameLabel, getHeadquartersCityName } from '../constants';
import { toFormControlValue, formatCurrency } from './formatters';
