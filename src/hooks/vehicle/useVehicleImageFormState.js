...
import { validateVehicleImageFile } from '../../utils/vehicleUtils';

/**
 * Estado de selección de imagen para formularios de vehículo (crear/editar).
 * Centraliza file, error, preview y handlers para eliminar duplicación.
 */
